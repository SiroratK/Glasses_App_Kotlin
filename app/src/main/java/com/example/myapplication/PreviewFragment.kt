...
class PreviewFragment : Fragment() {
    ...
    private val deviceStateCallback = object: CameraDevice.StateCallback(){
        ...
        override fun onDisconnected(camera: CameraDevice) {
            Log.d(TAG,"camera device disconected")
            camera.close()
        }
        ...
        cameraDevice.createCaptureSession(
            ...
            object : CameraCaptureSession.StateCallback(){
                override fun onConfigureFailed(session: CameraCaptureSession) {
                    Log.e(TAG,"creating caption session failed!")
                }
    ...
    private fun <T> cameraCharacteristics(cameraId:String,key: CameraCharacteristics.Key<T>):T?{
        ...
        return when(key){
            ...
            else -> throw IllegalArgumentException("Key not regcognized")
        }
    }
    ...
    private fun connectCamera(){
        ...
        try {
            ...
            Log.e(TAG,"Open camera device interrupt while opened")
        }
    }
    companion object{
    ...
    private fun checkCamerPermission(){
        if(EasyPermissions.hasPermissions(activity!!, Manifest.permission.CAMERA)){
            ...
            EasyPermissions.requestPermissions(activity!!,getString(R.string.camera_request_rationale),
